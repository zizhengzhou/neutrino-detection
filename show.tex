    ...
    \begin{columns}[c]
        ...
        \column{0.5\textwidth}
            ...
            \begin{itemize}
                ...
                Muon induced neutrons in shield should be removed via veto, while \textbf{Muon induced neutrons in concrete (outside shield) is leading} neutron background event rates.
                
                \item \textbf{Conclusion:} \\
                The proposed geometry (25 cm Pb + Borated PE) is \textbf{highly effective} against reactor radiation.
                The total background of neutrons in our ROI ($\sim 100$ events/y/kg) is smaller than the solar background.
...
\begin{frame}{Neutron flux(MC)}
    \begin{figure}
        \includegraphics[width=0.5\textwidth]{CONUS/component background flux.png}
        \caption{MC neutron background}
    \end{figure}
\end{frame}
