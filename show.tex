...
\begin{frame}{Reactor Neutrino CENvS Signal: Target comparison}
    \begin{columns}[T]
        ...
        \end{figure}
    \end{columns}
    From 10eV to 1000eV, the event rate per energy increases about 1 order for Si, while it increases about 5 orders for Xe. The difference is due to the mass of the target. We suggest to use heavy particles like Ge, GaAs \dots as the target.
\end{frame}
